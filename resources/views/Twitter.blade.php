                          ...
                          <a href="#">{{$fields->user->name}}</a>
                            <a href='#' class='pull-right btn-xs btn btn-primary'><i class='fa fa-retweet'></i> Retweet</a>
                                            ...
                                            <div class="row" style="padding-left: 10px"><img
                                                        src="{{url('/images/optimus/social/twlove.gif')}}"> {{ $fields->favorite_count }} <img
                                                        style="margin-left: 10px" height="20" width="20"
                                                        src="{{url('/images/optimus/social/retweet.png')}}"> {{ $fields->retweet_count }}</div>
                                                    ...
                                                    <li>
                                                        <div class="row">
                                                            <img style="padding-left: 10px"
                                                                 src="{{url('/images/optimus/social/twlove.gif')}}"> {{$obj->favorite_count}} <img
                                                                    style="margin-left: 10px" height="20" width="20"
                        ...
                        <span class='username'>
                          ...
                          <div data-id="{{$f->id}}" class="optimustwdel"><a class='pull-right btn-box-tool'><i
                                          class='fa fa-times'></i></a></div>
                                            ...
                                            <div class="row" style="padding-left: 10px"><img
                                                        src="{{url('/images/optimus/social/twlove.gif')}}"> {{ $f->favorite_count }} <img
                                                        style="margin-left: 10px" height="20" width="20"
                                                        src="{{url('/images/optimus/social/retweet.png')}}"> {{ $f->retweet_count }}</div>
