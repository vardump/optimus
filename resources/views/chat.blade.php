                                ...
                                @foreach(array_reverse($response['messages']['data']) as $data)
                                    <div class="direct-chat-msg @if($data['from']['id'] == $me)right @endif">
                                        <div class="direct-chat-info clearfix">
                                            ...
                                            <span class="direct-chat-timestamp pull-@if($data['from']['id'] == $me)left @else right @endif">{{\App\Http\Controllers\Op::date($data['created_time'])}}</span>
                                        </div>
                                        <!-- /.direct-chat-info -->
