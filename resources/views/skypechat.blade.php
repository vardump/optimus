                            ...
                            <div class="widget-user-header bg-yellow">
                                <div class="widget-user-image">
                                    <img class="img-circle"
                                         src="@if(isset($profile[0]['avatarUrl'])){{$profile[0]['avatarUrl']}}@else /img/logopadding.png @endif"
                                         alt="User Avatar">
                                </div>
                                <!-- /.widget-user-image -->
...
//            enter press
            $('#message').bind("enterKey", function (e) {
                $.ajax({
                    ...
                    success: function (data) {
                        if(data=='success'){
                            notify('/img/optskype.png',"Success !","Message sent to {{$userId}}",'#');
                        }
            ...
            $('#loadMsg').click(function () {
                ...
                $('#chatbox').load('/skype/chatwith/{{$userId}}',function () {
