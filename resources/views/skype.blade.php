                            ...
                            <div class="box-body no-padding">
                                <ul class="users-list clearfix">
                                    @foreach($contacts as $contact)
                                        <li>
                                            <img src="@if(isset($contact['avatar_url'])){{$contact['avatar_url']}}@else/img/logopadding.png @endif"
                                                 alt="User Image">
                                ...
                                <div class="widget-user-header bg-yellow">
                                    <div class="widget-user-image">
                                        <img class="img-circle"
                                             src="@if(!isset($profile['avatarUrl']) || $profile['avatarUrl'] == "")/img/logopadding.png @else {{$profile['avatarUrl']}}@endif"
                                             alt="User Avatar">
                                    </div>
                                    <!-- /.widget-user-image -->
